...
import com.example.anhtu_coffee.databinding.ActivityHangDoiBinding;

import java.util.ArrayList;
import java.util.List;

public class HangDoiActivity extends AppCompatActivity {
    ActivityHangDoiBinding binding;
    SQLiteDatabase db;
    Cursor cursor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_hang_doi);
    ...
    {
        String sql = "select * from _hoadon where ghichu='cho' ";
        ...
        sql = "select count(ban) from _hoadon where ghichu='cho'";
        cursor = db.rawQuery(sql, null);
        cursor.moveToFirst();
